  ...
  return (
    <div className="overflow-hidden">
      <div className="wrapper mt-[38px] grid grid-cols-1 md:grid-cols-2 items-center md:wrapper-md lg:wrapper-lg">
        ...
        <div className="w-full h-auto flex justify-center md:w-[640px] md:h-[640px] relative ">
          <img
          ...
          />
          <img
            className="w-full hidden  absolute top-[-120px] right-[-10px] z-1 md:block lg:top-[-160px]"
            src="../../public/img2.png"
            alt=""
          />
        </div>
