...
export const Content = () => {
  return (
    <div className="bg-gradient-to-b from-white to-[rgb(240,241,255)] pb-[5rem] flex w-full justify-center">
      <div className=" wrapper pt-[20px] grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="pt-[24px]">
              <div className="w-[21.4rem] h-[16.1rem] bg-white rounded-[10px] pl-[28px]">
                ...
                <div className="font-heading">
                  ...
                  <p className="text-[16px] text-[#83869A] font-medium mt-[17px]">{item.description}</p>
                  <button className="mt-[24px] text-[18px] font-bold text-[#F74780]">{item.buttonText}</button>
                </div>
              </div>
            </div>
          )
